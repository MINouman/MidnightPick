/* Built from feedback-widgets.jsx. Run: node scripts/build-jsx.js */
(function () {
  ...
  var deviceType = () => window.innerWidth <= 640 ? "mobile" : window.innerWidth <= 1024 ? "tablet" : "desktop";
  function MPFeedbackCard({
    orderRef
  }) {
    var doneKey = `mp_fb_done_${orderRef}`;
    var [phase, setPhase] = React.useState(() => localStorage.getItem(doneKey) ? "hidden" : "ask");
    var [emotion, setEmotion] = React.useState(null);
    ...
    if (phase === "thanks") return React.createElement("div", {
      className: "mpw-card"
    }, React.createElement("div", {
      className: "mpw-thanks"
    }, React.createElement("i", {
      className: "fa-solid fa-circle-check",
      "aria-hidden": "true"
    }), React.createElement("div", null, React.createElement("p", {
      className: "mpw-thanks-t"
    }, "Thank you!"), React.createElement("p", {
      className: "mpw-thanks-s"
    }, "Your note helps us make Midnight Pick smoother."))));
    var emotions = [{
      id: "very_easy",
      label: "Very easy",
    ...
    return React.createElement("div", {
    ...
    }, "How was your ordering experience?"), React.createElement("div", {
      className: "mpw-emotions",
      role: "radiogroup",
      "aria-label": "Was it easy to place your order?"
    }, emotions.map(e => React.createElement("button", {
      key: e.id,
      type: "button",
      role: "radio",
      "aria-checked": emotion === e.id,
      className: `mpw-emotion${emotion === e.id ? " selected" : ""}`,
      onClick: () => setEmotion(e.id)
    }, React.createElement("i", {
      className: `fa-solid ${e.icon} ${e.cls}`,
      "aria-hidden": "true"
    }), e.label))), emotion && React.createElement(React.Fragment, null, React.createElement("label", {
      className: "mpw-label",
      htmlFor: "mpw-comment"
    }, "What should we improve? ", React.createElement("span", {
      className: "mpw-opt"
    }, "Optional")), React.createElement("textarea", {
      id: "mpw-comment",
      className: "mpw-textarea",
      rows: 2,
      maxLength: 1000,
      ...
      disabled: busy,
      onClick: submit
    }, busy ? "Sending…" : "Submit Feedback")), React.createElement("button", {
      type: "button",
      className: "mpw-skip",
      onClick: skip
    }, "Maybe later"));
  }
  var SNOOZE_KEY = "mp_review_snooze_until";
  var DONE_KEY = "mp_review_done";
  var REVIEW_TAGS = [{
    id: "taste",
    label: "Taste"
  }, {
  ...
  var STAR_WORDS = ["", "Poor", "Fair", "Good", "Great", "Excellent!"];
  function MPReviewPrompt({
    source = "site_revisit",
    suppress = false,
    delay = 1400,
    triggerKey = 0,
    ...
    var [thanks, setThanks] = React.useState(false);
    React.useEffect(() => {
      if (manual) return;
      if (!hasLocalSignedInUser()) return;
      if (localStorage.getItem(DONE_KEY)) return;
      var snooze = parseInt(localStorage.getItem(SNOOZE_KEY) || "0", 10);
      if (snooze > Date.now()) return;
      var cancelled = false;
      var q = new URLSearchParams({
        product: productSlug
      });
      fetch(`${MP_API}/reviews/eligibility?${q.toString()}`, {
        credentials: 'include'
    ...
    var toggleTag = id => setTags(t => t.includes(id) ? t.filter(x => x !== id) : [...t, id]);
    var submit = async () => {
      if (!rating || busy) return;
      setBusy(true);
      setError("");
      try {
        var res = await fetch(`${MP_API}/reviews/submit`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json"
          },
    ...
    var word = STAR_WORDS[hover || rating];
    return React.createElement("div", {
      className: "mprv-overlay",
      onClick: e => e.target === e.currentTarget && dismiss(),
      role: "dialog",
      "aria-modal": "true",
      "aria-label": "Review your Midnight Pick"
    }, React.createElement("div", {
      className: "mprv-modal"
    }, React.createElement("div", {
      className: "mprv-handle",
      "aria-hidden": "true"
    }), React.createElement("button", {
      className: "mprv-close",
      onClick: dismiss,
      "aria-label": "Close"
    }, React.createElement("i", {
      ...
      className: "mprv-thanks"
    }, React.createElement("i", {
      className: "fa-solid fa-mug-hot",
      "aria-hidden": "true"
    }), React.createElement("h3", {
      className: "mprv-title"
    }, "Thank you!"), React.createElement("p", {
      className: "mprv-sub",
      style: {
        marginBottom: 0
      }
    }, "Your review has been submitted and will appear after admin approval.")) : React.createElement(React.Fragment, null, React.createElement("p", {
      className: "mpw-eyebrow"
    }, "Verified purchase"), React.createElement("h3", {
      className: "mprv-title"
    }, "Enjoyed your Midnight Pick?"), React.createElement("p", {
      className: "mprv-sub"
    }, "Your review helps other coffee lovers choose better."), React.createElement("p", {
      className: "mprv-q"
    }, "Rate your coffee experience"), React.createElement("div", {
      className: "mprv-stars",
      role: "radiogroup",
      ...
      className: "mprv-star-word"
    }, word), React.createElement("p", {
      className: "mprv-q"
    }, "What stood out most?"), React.createElement("div", {
      className: "mprv-tags"
    }, REVIEW_TAGS.map(t => React.createElement("button", {
      key: t.id,
      type: "button",
      className: `mprv-tag${tags.includes(t.id) ? " on" : ""}`,
      "aria-pressed": tags.includes(t.id),
      onClick: () => toggleTag(t.id)
    }, tags.includes(t.id) && React.createElement("i", {
      className: "fa-solid fa-check",
      "aria-hidden": "true"
    }), t.label))), React.createElement("label", {
      className: "mpw-label",
      htmlFor: "mprv-text"
    }, "Write a short review ", React.createElement("span", {
      className: "mpw-opt"
    }, "Optional")), React.createElement("textarea", {
      id: "mprv-text",
      className: "mpw-textarea",
      ...
      onClick: submit
    }, busy ? "Sending…" : "Submit Review"), React.createElement("button", {
      type: "button",
      className: "mpw-skip",
      onClick: dismiss
    }, "Not now"), React.createElement("p", {
      className: "mprv-reassure"
