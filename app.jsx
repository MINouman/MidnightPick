...
{ topic: "products", q: "Why is Midnight Pick more affordable than imported instant coffee?",    a: "Premium imported freeze-dried jars in Bangladesh carry a significant import markup that pushes the per-gram cost well beyond what most people would pay daily. Midnight Pick uses the same low-temperature freeze-drying process — without the import chain. Same quality, a fraction of the cost." },
